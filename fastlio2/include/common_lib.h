...
double calc_dist(PointType p1, PointType p2){
...
bool esti_plane(Matrix<T, 4, 1> &pca_result, const PointVector &point, const T &threshold)
{
    ...
    Matrix<T, 3, 1> normvec = A.colPivHouseholderQr().solve(b); //HouseholderQR分解
    // Matrix<T, 3, 1> normvec = A.bdcSvd(ComputeThinU| ComputeThinV).solve(b);// SVD分解 会报错，A必须有dynamic number of columns
